...
public interface ImageLoader extends Serializable {
    ...
    void displayHeadImage(Context activity, String path, ImageView imageView);

    void displayHeadImage(Context activity, String path, ImageView imageView, SimpleTarget<Bitmap> target);
    ...
    void displayVideoImage(Context activity, String path, ImageView imageView);
